...
extern __declspec(dllexport) PyObject* all_cmds(PyObject* self);
extern __declspec(dllexport) PyObject* parse_file(PyObject* self, PyObject* args);
extern __declspec(dllexport) PyObject* parse_string(PyObject* self, PyObject* args);
